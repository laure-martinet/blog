...
<body id="al_body">
    ...
    <main id=al_articles>
        ...
        ?>
        <div id=al_article>
        <a class="al_href" href="article.php?id=<?= $article['id']?>"><?= $article['titre']?> </a><br>
            ...
            <ul class="pagination">
                ...
                <?php for($page = 1; $page <= $pagestotales; $page++): ?>
                            <li class="btn btn-secondary btn-lg <?= ($currentPage == $page) ? "active" : "" ?>">
                                <a href="articles.php?page=<?= $page ?>"class="btn btn-secondary btn-lg"><?= $page ?></a>
                            </li>
                        <?php endfor ?>&emsp;
